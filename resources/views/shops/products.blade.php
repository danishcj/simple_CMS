            ...
            <div class="card">
               ...
               <tbody>
                  ...
                  <tr>
                     ...
                     <td>
                     <button class="btn btn-light"><a href="{{ route('shops.edit_product', $product->id) }}">EDIT</a></button>
                 
                      <form class="form-delete" method="post" action="{{ route('shops.destroy_product', $product->id) }}">
                                            @method('DELETE')
                                            @csrf
